...
(GLenum, GLuint))
SDL_PROC(void,glBlendFunc,
(GLenum, GLenum))
SDL_PROC_OES(void,glBlendEquationOES,
(GLenum))
SDL_PROC_OES(void,glBlendEquationSeparateOES,
(GLenum, GLenum))
SDL_PROC_OES(void,glBlendFuncSeparateOES,
...
SDL_PROC_OES(void,glDrawTexfOES,
(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat))
SDL_PROC(void,glEnable,
(GLenum))
SDL_PROC(void,glEnableClientState,
(GLenum))
...
(GLint, GLint, GLsizei, GLsizei))
SDL_PROC_OES(void,glBindFramebufferOES,
(GLenum, GLuint))
SDL_PROC_OES(void,glFramebufferTexture2DOES,
(GLenum, GLenum, GLenum, GLuint, GLint))
SDL_PROC_OES(GLenum,glCheckFramebufferStatusOES,(GLenum)
)
SDL_PROC(void,glPushMatrix,(void)
)
SDL_PROC(void,glTranslatef,
