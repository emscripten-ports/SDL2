...
DWORD fdwInit;
DWORD dwReserve[3];
}INPUTCONTEXT2,*PINPUTCONTEXT2,NEAR
*NPINPUTCONTEXT2,
FAR *LPINPUTCONTEXT2;
...
HKL ime_hkl;
void *ime_himm32;
UINT (WINAPI *GetReadingString)(HIMC himc,UINT
uReadingBufLen, LPWSTR lpwReadingBuf,PINT
pnErrorIndex, BOOL *pfIsVertical,PUINT
puMaxReadingLen);
BOOL (WINAPI *ShowReadingWindow)(HIMC himc,BOOL
bShow);
