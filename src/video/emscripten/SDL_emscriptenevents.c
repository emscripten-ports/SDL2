...
{
    /* There is either only one window and that window is the canvas or multiple windows mapped to the single canvas */
    wdata = data;
    emscripten_set_mousemove_callback("#canvas", NULL, 0, Emscripten_HandleMouseMove);

    emscripten_set_mousedown_callback("#canvas", NULL, 0, Emscripten_HandleMouseButton);
    emscripten_set_mouseup_callback("#document", NULL, 0, Emscripten_HandleMouseButton);

    emscripten_set_mouseenter_callback("#canvas", NULL, 0, Emscripten_HandleMouseFocus);
    emscripten_set_mouseleave_callback("#canvas", NULL, 0, Emscripten_HandleMouseFocus);

    emscripten_set_wheel_callback("#canvas", NULL, 0, Emscripten_HandleWheel);

    emscripten_set_focus_callback("#window", NULL, 0, Emscripten_HandleFocus);
    emscripten_set_blur_callback("#window", NULL, 0, Emscripten_HandleFocus);

    emscripten_set_touchstart_callback("#canvas", NULL, 0, Emscripten_HandleTouch);
    emscripten_set_touchend_callback("#canvas", NULL, 0, Emscripten_HandleTouch);
    emscripten_set_touchmove_callback("#canvas", NULL, 0, Emscripten_HandleTouch);
    emscripten_set_touchcancel_callback("#canvas", NULL, 0, Emscripten_HandleTouch);
    ...
    emscripten_set_resize_callback("#window", NULL, 0, Emscripten_HandleResize);
